import { Bell, ChevronDown, Filter, Menu, Search, Settings, Home } from 'lucide-react'
import React from 'react'

function Header({sidebarCollapsed, onToggleSidebar, breadcrumb = ['Dashboard'], onGoHome}) {
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center space-x-1'>
                    ...
                    {onGoHome && (
                        <button 
                            onClick={onGoHome}
                            className='bg-orange-500 text-white rounded-xl p-2 hover:bg-orange-600 
